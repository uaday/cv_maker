...
if ($_SESSION['type'] == 'A' || $_SESSION['type'] == 'a') {
    ...
    $result4 = $obj_sup->count_all_jobs();
    $row4 = mysqli_fetch_assoc($result4);
    $result5 = $obj_sup->count_all_jobs_applicant();
...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header fa-3x" align="center" style="text-decoration: none;"><a href="../index.php"
                                                                                           style="text-decoration: none; color: #535b60;"><img
                            src="">Job Recruitment</a></h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
                ...
                <div class="panel panel-success">
                    <div class="panel-heading">
                        <div class="row">
                            ...
                            <div class="col-xs-9 text-right">
                                <div class="huge"><?php echo $row4['j'] ?></div>
                                <div>Total Jobs</div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="panel panel-info">
                    <div class="panel-heading">
                        <div class="row">
                            ...
                            <div class="col-xs-9 text-right">
                                <div class="huge"><?php echo $row5['ja'] ?></div>
                                <div>Total Job Application</div>
                            </div>
                        </div>
                    </div>
