...
--
-- Host: localhost
-- Generation Time: Feb 06, 2020 at 09:36 PM
...
INSERT INTO `tbl_basic` (`user_id`, `login_id`, `career_object`, `first_name`, `last_name`, `email`, `phone`, `web`, `gender`, `skills`, `dob`, `address`, `photo`) VALUES
(15, 23, 'Highly motivated individual and a certified digital marketer with strong SEO and SEM skills, attention to detail, and a solid online marketing background looking to obtain a position of SEO Specialist with XYZ company.', 'Sudipta', 'Ghosh', 'uadayghosh@gmail.com', '01830697059', 'uadayghosh.pixub.com', 'male', 'sgfdsgsd,g,sdfg,fdsf', '1995-06-24', 'Green Road Dhaka-1205', 'asset/front_end/image/17201143_1247043068745890_6053309860395554894_n.jpg'),
...
INSERT INTO `tbl_job_application` (`id`, `tbl_job_circular_id`, `tbl_login_id`, `rating`, `comments`, `template`, `created_on`, `status`) VALUES
(6, 3, 23, '50', NULL, 't1', '2020-01-08 19:42:16', 1);
